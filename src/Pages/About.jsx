...
//   const { totalProjects, totalExperiences, YearExperience } = useMemo(() => {
...
//       totalExperiences: storedExperiences.length,
...
//       },
//     ],
//     [totalProjects, totalExperiences, YearExperience]
//   );
...
//               </span>
//               <span
//                 className="block mt-2 text-4xl text-gray-200"
//                 data-aos="fade-right"
//                 data-aos-duration="1300"
//               >
...
//               data-aos-duration="1500"
//             >
//               Computer Science graduate with 1+ year of experience in enterprise
//               software development. Demonstrated strong leadership as a project
//               and division lead across 4+ events. Adaptable and eager to
//               leverage technical and analytical skills across software, product,
//               data, and business-focused technology roles.
//             </p>
...
//                 "Technology enables solutions, people create impact."
//               </blockquote>
//             </div>

//             <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
//               <a
//                 href="https://drive.google.com/drive/folders/1V-ZZowVNwSTI4WYTJ5dTHjQYKYsYWK3c?usp=sharing"
...
const StatCard = memo(
  ({ icon: Icon, color, value, label, description, animation }) => (
    <div data-aos={animation} className="relative group">
      <div className="bg-gray-900/50 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:scale-105 transition-all">
        <div
          className={`absolute inset-0 bg-gradient-to-br ${color} opacity-10 group-hover:opacity-20`}
        />
...
const AboutPage = () => {
  ...
  /* ===== FETCH STATS FROM SUPABASE (DEPLOY SAFE) ===== */
  useEffect(() => {
    const fetchStats = async () => {
      try {
        ...
        setTotalExperiences(experiences?.length || 0);
      } catch (err) {
